...
const controlSearchResult = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).render((0, _modelJs.getSearchResultPage)());
...
const controlPagination = function(goToPage) {
    ...
    (0, _resultsViewJsDefault.default).render((0, _modelJs.getSearchResultPage)(goToPage));
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"cfHEn","./config.js":"7c2aR","regenerator-runtime/runtime":"f6ot0","./views/recipeView.js":"fLbry","./views/searchView.js":"5aK57","./views/resultsView.js":"lYFJn","./views/paginationView.js":"3kBPa","./views/bookmarksView.js":"2vc5x","./views/addRecipeView.js":"8Ye1u","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const updateServings = function(newServings) {
    ...
    //formula; newQt = oldQ * newServings / oldServings // 2*8/4=4
    });
...
},{"regenerator-runtime":"f6ot0","./config":"7c2aR","./helpers":"2QjiY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
const KEY = 'e0c7c037-446b-4eae-b71d-05819099d724';
...
},{"./config":"7c2aR","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fLbry":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = 'Opps!! We could not find the recipe. Try another one.';
    _Sucessmessage = '';
    _generateMarkup() {
        return `
...
},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","url:../../img/icons.svg":"apwnT","fracty":"gsPKI","./View":"l0Asn","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"apwnT":[function(require,module,exports,__globalThis) {
...
},{}],"l0Asn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
   ...
   * @returns  {boolean} [render=true] If false, create markup string instead of rendering to the DOM
   * @returns {undefined | string} A markup string is returned if render=false
   * @this {Object} View instance
   * @author Wilkenson Devariste
...
class ResultsView extends (0, _previewViewDefault.default) {
    ...
    _errorMessage = 'No recipe found for your search query. Try again or check for possible mistake.';
    _Sucessmessage = '';
}
exports.default = new ResultsView();

},{"./View":"l0Asn","./previewView":"8rL4Y","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8rL4Y":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
    ...
    _generateMarkup() {
        ...
        if (curPage === numPages && numPages > 1) return `
            <button data-goto="${curPage - 1}" class="btn--inline pagination__btn--prev">
                <svg class="search__icon">
                <use href="${0, _iconsSvgDefault.default}#icon-arrow-left" xlink:href="${0, _iconsSvgDefault.default}#icon-arrow-left" ></use>
                </svg>
                <span>Page ${curPage - 1}</span>
            </button>
            `;
...
},{"./View":"l0Asn","./previewView":"8rL4Y","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8Ye1u":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./View":"l0Asn","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3cF9g","dGopa"], "dGopa", "parcelRequire3a11", {}, "./", "/")
